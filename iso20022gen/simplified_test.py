"""
Simplified test of model-based XML generation.
"""
import json
import sys
...
def test_simplified(payload_file):
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python -m iso20022gen.simplified_test <payload.json>")
        sys.exit(1)
    
    payload_file = sys.argv[1]
    test_simplified(payload_file) 